...
export default function Homepage() {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setAnimation("exit"); // Start exit animation
      setTimeout(() => {
        setCurrentIndex((prevIndex) => (prevIndex + 1) % texts.length);
        setAnimation("enter"); // Reset to enter animation for next text
      }, 2000); // Time this with the CSS animation duration
    }, 6000); // Increase to 6 seconds for longer display
  ...
  const emailtrigger = () => {
    window.location.href =
      "mailto:bryananoruo@gmail.com?subject=Subject&body=message%20goes%20here";
  };
  return (
    <>
      <motion.div
        className="homepagemaincon"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      >
        <section className=" -z-10 section1  pb-5">
          {/* <div className="filter_img absolute h-full top-0"></div> */}
          <Navbar />
          <span className="w-full h-screen flex justify-center items-center flex-col">
            ...
            <span className="">
              <span className="flex justify-center items-center gap-3 relative left-24 test">
                ...
                <div className="rotating-text flex justify-center items-center w-[14.1em]">
                  <p className={animation}>{texts[currentIndex]}</p>
                </div>
                <img src="/images/star.svg" className="star" alt="" />
                <p className="section1_p2">
                  who bridges people with devices, experiences, stories
                </p>
              </span>
        ...
        <section className="section2 overflow-hidden">
          {/* this div is for animation this part */}
          <div>
            <p className="text-white uppercase text-start section2_p">
              30 seconds why bryan is goated <span>...</span>
            </p>
            <div className="section2_reelVid flex justify-center items-center relative">
              <video
                src="./images/Bryan.mp4"
              ...
              {/* <div
                style={{
                  position: "absolute",
                  left: poninterLocation.X,
                  top: poninterLocation.Y,
          ...
          <div className="flex justify-center aboutmeCon">
            ...
            <span className="">
              <p className="section2_detailabout overflow-hidden">
                An emphatic creative, award-winning multidisciplinary designer.
                Bryan creates impactful experiences with design. With
                strategy-infused experience and passion, Bryan commands great
                expertise in several design fields, from Product design, Brand
                identity, to Motion design.
              </p>
              <button className="aboutBtn" onClick={aboutme}>
                ...
                <span>
                  ...
                  >
                    <path
                      d="M-2.84124e-07 6.5L18.5714 6.5M18.5714 6.5C16.5079 6.5 12.381 7.8 12.381 13M18.5714 6.5C16.5079 6.5 12.381 5.2 12.381 4.12486e-07"
                      stroke="white"
            ...
            <span className="">
              <p className="section2_detailabout2">
                Driven by grit & dedicated to quality, he delivers innovative
                and profitable design solutions by making data-informed
                decisions.
              </p>
            </span>
          </div>
          ...
          <div className="recentWorksCon flex mb-80">
            ...
            <div className=" mb-80 flex  recentWorksCon_innerCon">
              ...
              <div className="relative clubhouse">
                <a
                  href="https://www.behance.net/gallery/120048355/CLUBHOUSE-RE-BRANDING-PROJECT-PROJECTMUTEYOURMIC"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <Works
              ...
              <div className="relative yellostar">
                <a
                  href="https://www.behance.net/gallery/152733905/Orion-Rebrand-Broadcast-Design"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <Works
