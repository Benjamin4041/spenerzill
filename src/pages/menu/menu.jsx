      ...
      <div className="menu">
          ...
          <Link to={"/about"} onClick={()=>setIsActive(false)}>
            <div className="menus">
              <div className="menus_imgCon">
                <img
                  src="/images/CurvedUIRender.png"
                  alt=""
                  className="menus_imgCon-img"
                />
              </div>
        ...
        <footer className="menu_footer">
          <span className="flex flex-wrap socialCon">
            ...
            <p className="socials">Dribbble</p>
            <p className="socials">Instagram</p>
            <p className="socials">Behance</p>
            <p className="socials">Facebook</p>
            <p className="socials">Meduim</p>
          </span>
          <span className="menu_footer-innerCon">
            <p className="menu_footer-p">
              "You use a glass mirror to see your face. You use works of art to
              see your soul."
            </p>
            <p className="menu_footer-p flex items-center">
              <hr className="footer_p-hr" />
              George Bernard Shaw
            </p>
          </span>
        </footer>
...
//3d version of the menu

// export function MenuOrb() {
//   return (
//     <>
//       <Spline
//         scene="https://prod.spline.design/IRbf0SwGcyDClZfS/scene.splinecode"
//         className="w-full h-screen scale-[1.19] overflow-hidden scroll-m-0"
//       />
//     </>
//   );
// }
